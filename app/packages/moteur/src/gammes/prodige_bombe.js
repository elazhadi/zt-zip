...
function accessoiresChassis(c) {
  ...
  add("1302",        "Équerre dormant à pion PURLINE",             8,         "unité");
  if (a.rails === 2) {
    add("BU-6024V2", "Bouchon dormant 6024V2/6025V2 (2R)",        2,         "unité");
  ...
  add("6325V1",      "Bouchon montant latéral PURLINE",            a.latQ,    "lot");
  add("6320V1",      "Bouchon montant central PURLINE",            a.centrQ,  "lot");
